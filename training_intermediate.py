...
labels = ["hello", "howAre", "love", "mask", "no", "please", "sorry", "thanks", "wear", "you",
          ...
          "excited"]
# labels = ["afternoon", "angry", "bye", "chair", "computer", "confused", "drink", "eat", "evening", 
#           "excited", "good", "happy", "hello", "how", "howAre", "hungry", "love", "mask", "morning", 
#           "no", "phone", "please", "run", "sad", "sit", "sleep", "sorry", "stand", "table", "thanks", 
#           "thirsty", "tired", "walk", "wear", "what", "when", "where", "who", "why", "you"]
        ...
        if os.path.isdir(class_path):
            for video_file in sorted(os.listdir(class_path)):
                if class_folder in labels:
                    ...
                    print(f"Video: {video_path}, Label: {class_folder}")
